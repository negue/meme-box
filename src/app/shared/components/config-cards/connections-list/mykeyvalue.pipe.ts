...
// copied from ANgular Source until the KeyValue Pipe works fine inside the Angular Language Service.
...
// THIS IS A 1:1 COPY FROM ANGULAR YET THE SHIPPED ANGULAR VERSION DOESNT WORK !!!!!!!ONEONEONEeleven
 ...
 * @publicApi
 */
@Pipe({name: 'mykeyvalue', pure: false})
